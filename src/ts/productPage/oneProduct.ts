...
export const oneProduct = (
  oneProduct?: Product[],
  productPageContainer?: HTMLElement,
  text?: string
) => {
  if (oneProduct && oneProduct.length > 0 && productPageContainer && text) {
    ...
    imgAndDescription___imgContainer.classList.add(
      "imgAndDescription___imgContainer"
    );
    const imgAndDescription___imgContainer___img =
      document.createElement("img");
    imgAndDescription___imgContainer___img.classList.add(
      "imgAndDescription___imgContainer___img"
    );
    ...
    imgAndDescription___description.classList.add(
    ...
    /* button container */
    const imgAndDescription___buttonsContainer =
      document.createElement("section");
    imgAndDescription___buttonsContainer.classList.add(
      "imgAndDescription___buttonsContainer"
    );
    /* button - add */
    const imgAndDescription___buttonsContainer___button =
      document.createElement("button");
    imgAndDescription___buttonsContainer___button.classList.add(
    ...
    buttonReadMore.classList.add(
      "imgAndDescription___buttonsContainer___buttonReadMore"
    );
    ...
    imgAndDescription___imgContainer.appendChild(
      imgAndDescription___imgContainer___img
    );
    /* description  */
    ...
    imgAndDescription___description.appendChild(
      imgAndDescription___buttonsContainer
    );
    imgAndDescription___buttonsContainer.appendChild(buttonReadMore);
    imgAndDescription___buttonsContainer.appendChild(
      imgAndDescription___buttonsContainer___button
    );
