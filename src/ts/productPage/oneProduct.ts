import { pushProduct } from "../functions/pushProductToBasket";
...
export const oneProduct = (
  ...
  if (oneProduct && oneProduct.length > 0 && productPageContainer) {
    ...
    imgAndDescription___button.addEventListener("click", () => {
      pushProduct(oneProduct[0]);
      console.log(imgAndDescription___button, "klickade");
    });
